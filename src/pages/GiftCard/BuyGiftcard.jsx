...
const BuyGiftcard = () => {
    ...
    return (
        <div className="sm:px-[184px] px-[10px] py-[60px]">
            ...
            {currentForm === "senderDetails" ? <form onSubmit={handleSubmit(handleSubmitFirstForm)} className="flex flex-col sm:flex-row justify-between px-[20px] sm:px-[50px]">
                <div className="flex flex-col">
                    ...
                    <div>
                        ...
                        <input type="text" min="0" placeholder="Enter Number" className="border w-[295px] sm:w-[442px] px-[10px] rounded-[10px] py-[10px]" {...register("number", { required: "Please enter your number", minLength: { value: 10, message: "Enter a valid number" }, maxLength: { value: 11, message: "Enter a valid number" } })} />
                ...
                <form onSubmit={handleSubmit(handleOpenModal)} className="flex flex-col justify-between px-[20px] sm:px-[50px]">
                    ...
                    <div className="">
                        ...
                        <input type="text" placeholder="Receiver Name" className="border  sm:w-[442px] w-[295px] px-[10px] rounded-[10px] py-[10px]" {...register("receiverName", { required: "Please enter receiver name" })} />
                    ...
                    <div>
                        ...
                        <input type="number" min="0" placeholder="Enter Receiver Number" className="border w-[295px] sm:w-[442px] px-[10px] rounded-[10px] py-[10px]" {...register("receiverPhoneNumber", { required: "Please enter reciever number", minLength: { value: 10, message: "Enter a valid number" }, maxLength: { value: 11, message: "Enter a valid number" } })} />
                    ...
                    <div>
                        ...
                        <input type="text" min="0" placeholder="Enter Receiver Email" className="border w-[295px] sm:w-[442px] px-[10px] rounded-[10px] py-[10px]" {...register("receiverEmail", { validate: (val) => { return !val ? true : val.includes("@") ? true : "Enter a valid Email" } })} />
