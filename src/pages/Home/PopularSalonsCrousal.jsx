...
const PopularSalonsCrousal = () => {
    ...
    return (
        <>
            ...
            <div className=' px-[10px] my-[60px] relative max-w-[1400px] sm:mx-auto'>
                <div className='flex justify-between mb-[20px]'>
                <h1 className='font-bold text-[30px] '>Popular Salons</h1>
                <Link to='/all-salons'> <button className='flex hidden sm:block hover:text-[white] text-blue-600 bg-[#3554D10D] px-[10px] py-[10px] hover:bg-[#3554D1]'> <span className='flex gap-[10px]'>View All Salons <ArrowUpRight /> </span>   </button>
               </Link>
                </div>
                <Swiper
                    slidesPerView={1}
