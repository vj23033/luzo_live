...
const HowToUse = () => {
    ...
    return (
        <>
            ...
            <dialog ref={modalRef} className='backdrop:backdrop-blur-sm half-transparent-backdrop z-30 overflow-hidden relative bg-transparent '>
                <div className='flex flex-col items-center'>
                <span className='bg-black text-white p-4 rounded-full -top-[50px] left-[50%] cursor-pointer hover:bg-blue-400 z-40' onClick={handlCloseModal}>
                    <X />
                </span>
                ...
                <video controls loop playsInline className={"w-[35%] h-full mx-auto"} ref={videoRef} >
