...
const HeaderCrousal = () => {
  return (
    <div>
        ...
        >
            <SwiperSlide>
                <div className='flex flex-col items-center  justify-center min-h-[70vh] bg-[url("/img/11.webp")]  bg-cover bg-no-repeat relative'>
            ...
            <SwiperSlide>
                <div className='flex flex-col items-center justify-center min-h-[70vh] bg-[url("/img/12.webp")] bg-cover bg-no-repeat relative'>
            <div className='w-full h-full absolute left-0 top-0 overlay'></div>
                    <div className='flex flex-col items-center z-10'>
                            <h1 className='font-bold text-[white] text-[50px]'>40% OFF</h1>
            ...
            <SwiperSlide>
                <div className='flex flex-col items-center justify-center min-h-[70vh] bg-[url("/img/13.webp")] bg-cover bg-no-repeat relative'>
            <div className='w-full h-full absolute left-0 top-0 overlay'></div>
                    <div className='flex flex-col items-center z-10'>
                            <h1 className='font-bold text-[white] text-[50px]'>40% OFF</h1>
