...
export const Lemon = () => {
  return (
    ...
    <Navbar />
    <div>
         <img src="/SalonPhotos/lemon.webp" className="col-12 rounded-4 w-full h-[40vh] object-cover"/>

         <div className="px-[120px] leading-[30px] ">
              <h1 className="font-semibold text-[50px] py-[20px]">Juice</h1>
              <p className="text-[16px] mb-[10px]">LEMON is synonymous with quality beauty and hair solutions. They are on a mission to help our clients love themselves. Each time they step out of our salon, they should feel the best version of themselves. We believe in delivering an experience to remember. We pride ourselves on discreet, attentive care brought to our customers by one of the most directional teams of hair stylists and beauty therapists in the salon industry.</p>
          </div>
