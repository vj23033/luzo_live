  ...
  return (
    ...
    <div>
         ...
         <div className="px-[120px] leading-[30px] ">
              ...
              <p className="text-[14px] my-[20px]">LEMON is synonymous with quality beauty and hair solutions. They are on a mission to help our clients love themselves. Each time they step out of our salon, they should feel the best version of themselves. We believe in delivering an experience to remember. We pride ourselves on discreet, attentive care brought to our customers by one of the most directional teams of hair stylists and beauty therapists in the salon industry.</p>
          </div>
