  ...
  return (
    ...
    <div>
         ...
         <div className="px-[120px] leading-[30px] ">
              ...
              <p className="text-[14px] my-[20px]" >“The First” is an intimate salon in Pune that is favoured by a discerning clientele and fashion insiders.</p>             
              <p className="text-[14px] my-[20px]">It is meant to be a discreet space that offers beauty editors superior services consistently with a happy and relentless attitude while standing within an affordable budget.</p>
              <p className="text-[14px] my-[20px]">As a new lifestyle concept, what they offer you is not just a luxury salon but a post-work retreat, a place to relax and what is more, the coffee here is to die for.</p>
            </div>
