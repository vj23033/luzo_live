...
const TheFirst = () => {
  return (
    ...
    <Navbar />
    <div>
         <img src="/SalonPhotos/TheFirst.webp" className="col-12 rounded-4 w-full h-[380px] object-cover"/>

         <div className="px-[120px] leading-[30px] ">
              <h1 className="font-semibold text-[50px] py-[20px]">Juice</h1>
              <p className="text-[16px] my-[20px]" >“The First” is an intimate salon in Pune that is favoured by a discerning clientele and fashion insiders.</p>             
              <p className="text-[16px] my-[20px]">It is meant to be a discreet space that offers beauty editors superior services consistently with a happy and relentless attitude while standing within an affordable budget.</p>
              <p className="text-[16px] my-[20px]">As a new lifestyle concept, what they offer you is not just a luxury salon but a post-work retreat, a place to relax and what is more, the coffee here is to die for.</p>
            </div>
