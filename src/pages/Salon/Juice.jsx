  ...
  return (
    ...
    <div>
         ...
         <div className="px-[120px] leading-[30px] ">
              ...
              <p className="text-[16px] mb-[10px]">JUICE is one of India’s trendiest salon chains with 30+ branches spread internationally. In India, Juice has a widespread presence across metros and mini-metros catering to the beauty needs of ardent fashion followers, trendsetters and celebrities.</p>
              <p className="text-[16px] mb-[10px]">This leading salon chain aims to bring the latest fashion trends and cutting-edge technology to their customers in a comfortable and sleek environment, using the best international products in the market. Hair stylists at JUICE believe that perfect beauty is different for every person which is why they do not mass produce but tailor-make a look, keeping in mind an individual’s features when conceiving their cut and colour.</p>
              <p className="text-[16px] mb-[10px]">Their fundamental belief is that each customer is special and they work hard to make each one feel that before they walk out of their salon.</p>
          </div>
