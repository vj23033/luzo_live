  ...
  return (
    ...
    <div>
         ...
         <div className="px-[120px] leading-[30px] ">
              ...
              <p className="text-[16px] my-[20px]">It started as a way for people from the fashion industry to hang out, this led Michel Adam to come up with a channel dedicated 24*7 to fashion and this led to the birth of Fashion. With 20+ years in India and presence in more than 100 countries today, FashionTV is loved globally.</p>
            </div>
