...
const FashionTv = () => {
  return (
    ...
    <Navbar />
    <div>
         <img src="/SalonPhotos/FTV.webp" className="col-12 rounded-4 w-full h-[40vh] object-cover"/>

         <div className="px-[120px] leading-[30px] ">
              <h1 className="font-semibold text-[50px] py-[20px]">Fashion TV</h1>
              <p className="text-[16px] mb-[10px]">It started as a way for people from the fashion industry to hang out, this led Michel Adam to come up with a channel dedicated 24*7 to fashion and this led to the birth of Fashion. With 20+ years in India and presence in more than 100 countries today, FashionTV is loved globally.</p>
            </div>
