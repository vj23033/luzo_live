  ...
  return (
    ...
    <div>
         ...
         <div className="px-[120px]">
              ...
              <p className="text-[16px] my-[20px]">Prithivi, Akash, Jal, Agni, Vayu (Earth, Sky, Water, Fire, Air) are the five Tattva’s or elements that the universe and the human body is composed of.</p>
              <p className="text-[16px] my-[20px]">Ancient eastern philosophy holds that the balance of these five Tattvas or elements in entire universe, including the human body, is the essence of wellness.</p>
              <p className="text-[16px] my-[20px]">Balance. That is what Tattva Spa aims to strive for your mind, body and soul.</p>
