  ...
  return (
    ...
    <div>
         ...
         <div className="sm:px-[120px] px-[10px] leading-[30px] ">
              ...
              <p className="text-[16px] my-[20px]">Apple Unisex Salon was incepted with a dream to not just change people’s appearances, but also to infuse their life with positivity and confidence.</p>
              <p className="text-[16px] my-[20px]">They offer premium quality hair and beauty services that enhance and enrich personalities.</p>
              <p className="text-[16px] my-[20px]">All their staff is highly trained and are professionals with years of experience who bring you the best style tips, recommendations, and services to ensure that your experience at Apple is truly relaxing, pampering, and fulfilling</p>
               </div>
